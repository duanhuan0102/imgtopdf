...
export const toolDefinitions: ToolDefinition[] = [
  ...
  },
  {
    ...
    eyebrow: "PDF → Word",
    description: "Convert PDF to Word in your browser to create a real DOCX with selectable text, visible graphics, and a readable page structure. Scanned PDFs may need OCR.",
    cardDescription: "Create an editable DOCX from PDF",
    inputLabel: "Drop a PDF here",
    ...
    group: "from-pdf",
    featured: true,
    options: ["Selectable text", "Layout", "Page range"],
    related: ["pdf-to-img", "compress-pdf"],
    faqs: [
      { question: "What kind of PDF works best?", answer: "PDFs with a selectable text layer give the most editable result. Text, headings, and many document graphics can be carried into a DOCX while the page structure remains recognizable." },
      { question: "Will the DOCX preserve graphics and page layout?", answer: "Choose Preserve layout to keep the rendered page graphics behind editable text boxes. Word may still reflow unusual fonts, columns, tables, or complex effects, so review the downloaded file before sharing it." },
      { question: "Can scanned PDFs become editable?", answer: "Scanned pages are usually image-only and need OCR to recognize their words. The current browser workflow can preserve the visible scan, but it does not promise editable text for pages without a text layer." },
      { question: "Can I convert only the first page?", answer: "Yes. Select First page when you only need a cover, sample, or single page; choose All pages for the complete document. Browser conversion is limited to PDFs with 100 pages or fewer." },
      { question: "Is the converter free and private?", answer: "Yes. No account is required, and the current conversion runs in your browser. Files are processed on your device rather than uploaded to the site; keep the original until you have checked the DOCX." },
    ],
  },
  {
    slug: "compress-pdf",
